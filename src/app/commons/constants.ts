export class TOOLTIP_DEFINITIONS {
    static COLUMNS_MERGING_DESCR : string = "Create a new column by mergind two or more columns from the excel. The only requirements will be to select at least 2 columns and to choose a name not already present";
